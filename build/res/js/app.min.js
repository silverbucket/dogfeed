 ...
 * run
 */
run(['$rootScope', 'SockethubSettings', 'SH', 'RS', 'local_settings',
function ($rootScope, settings, SH, RS, local_settings) {
  ...
  $rootScope.$on('sockethubSettingsSaved', function () {
    ...
    RS.call('sockethub', 'writeConfig', [local_settings.appName, settings.conn]).then(function () {
...
factory('SockethubBootstrap', ['RS', 'SockethubSettings', '$rootScope', 'SH', '$timeout', 'local_settings',
function (RS, settings, $rootScope, SH, $timeout, local_settings) {
  function run(appName, defaultCfg) {

    if (typeof appName === 'string') {
      local_settings.appName = appName;
    }
    ...
    RS.call('sockethub', 'getConfig', [local_settings.appName]).then(function (c) {
