    ...
    copy: {
      main: {
        files: [
          ...
          {expand: false, src: ['vendor/remotestorage/remotestorage-nocache.js'], dest: 'build/vendor/remotestorage-nocache.js', filter: 'isFile'}, // includes files in path and its subdirs
